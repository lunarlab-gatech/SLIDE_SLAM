...
tmux send-keys -t $SESSION_NAME "$SETUP_ROS_STRING; sleep 2; roscd sloam && roslaunch sloam decentralized_sloam_multi_robot_dcist.launch enable_rviz:=true" Enter

# Standalone version of the linear_assignment function from sklearn which is used for Hungarian assignment tracking
# All code belongs to the authors described below. The code was just copied here for standalone use and nothing was modified.
"""
